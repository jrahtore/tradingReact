...
class Header extends Component {
  ...
  render() {
    return (
      <React.Fragment>
        <header id="page-topbar" style={{ backgroundColor: "blue" }}>
          <div className="navbar-header">
            <div className="d-flex">
              ...
              <Button size="sm" color="none" type="button" onClick={this.toggleMenu}
                ...
                <i className="ri-menu-2-line align-middle" style={{ color: "white" }}></i>
              </Button>


              <Form className="app-search d-none d-lg-block">
                <div className="position-relative">
                  <h2 style={{ color: "white", fontFamily: 'Material Design Icons', fontWeight: "700" }}>TRADE FEVER</h2>
                  {/* <Input type="text" className="form-control"
                                 placeholder={this.props.t('Sea')}/>
            ...
            <div className="d-flex">
              ...
              <div className="dropdown d-none d-lg-inline-block ml-1">
                <Button color="none" type="button" style={{ color: "white" }} className="header-item noti-icon waves-effect"
