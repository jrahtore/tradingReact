                ...
                <div className="navbar-header">
                    <div className="d-flex">
                        ...
                        <Form className="app-search d-none d-lg-block">
                            <div className="position-relative">
                                <Input type="text" className="form-control" placeholder={this.props.t('Sea')}/>
                    ...
                    <div className="d-flex">
                        ...
                        <div className="dropdown d-inline-block d-lg-none ml-2">
                            <Button color="none" type="button" onClick={() => { this.setState({ isSearch: !this.state.isSearch }); }} style={{color:"white"}} id="page-header-search-dropdown" >
