                                    ...
                                    <Col lg={9}>
                                        <div>
                                            ...
                                            <div className="p-2 mt-5">
                                                <AvForm className="form-horizontal" >
                                                    ...
                                                    <div className="mt-4 text-center">
                                                        <Button color="primary" className="w-md waves-effect waves-light" type="submit">Log </Button>
                                                    </div>
                                            ...
                                            <div className="mt-5 text-center">
                                                ...
                                                <p>© UNIQUE TRADERS. Crafted with <i className="mdi mdi-heart text-danger"></i> by UNIQUE TRADERS</p>
                                            </div>
                                        </div>
